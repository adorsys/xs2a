...
$ mvn spring-boot:run
```
Open a browser on page [https://localhost:28080/swagger-ui.html](https://localhost:28080/swagger-ui.html)
...
$ mvn spring-boot:run 
```
Open a browser on page [https://localhost:8080/swagger-ui.html](https://localhost:8080/swagger-ui.html)
