...
public class PaymentMapper {
    public AspspPayment mapToAspspPayment(SpiSinglePayment singlePayments, PisPaymentType paymentType) {
    ...
    public SpiSinglePayment mapToSpiSinglePayments(AspspPayment aspspPayment) {
