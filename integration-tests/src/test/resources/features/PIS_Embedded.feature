Feature: Payment Initiation Embedded approach
    ...
    Scenario Outline: Successful Authorisation with PSU Identification (embedded)
        Given PSU initiated a payment <payment-service> with the payment-id <payment-id>
        And PSU needs to authorize and identify using <authorisation-data>
        ...
        Examples:
            ...
            | payments	      | a9115f14-4f72-4e4e-8798-202808e85238 | authWithPsuIdent-successful.json |
