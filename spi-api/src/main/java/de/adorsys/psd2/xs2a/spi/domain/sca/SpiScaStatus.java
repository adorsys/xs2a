...
public enum SpiScaStatus {
    ...
    private static final Map<String, SpiScaStatus> HOLDER = new HashMap<>();

    static {
        for (SpiScaStatus status : SpiScaStatus.values()) {
    ...
    SpiScaStatus(String value, boolean finalisedStatus) {
        this.value = value;
     ...
     */
    @JsonCreator
    public static SpiScaStatus fromValue(String text) {
