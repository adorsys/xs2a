...
public interface SinglePaymentSpi extends PaymentSpi<SpiSinglePayment, SpiSinglePayment> {
    @NotNull
    @Override
    default SpiResponse<SpiSinglePayment> initiatePayment(@NotNull SpiSinglePayment payment, @NotNull AspspConsentData aspspConsentData) {
        return SpiResponse.<SpiSinglePayment>builder().fail(SpiResponseStatus.NOT_SUPPORTED);
    }

    @Override
    default SpiResponse<VoidResponse> executePaymentWithoutSca(SpiSinglePayment payment, AspspConsentData aspspConsentData) {
    ...
    @Override
    default SpiResponse<SpiAuthorizationCodeResult> requestAuthorisationCode(String psuId, SpiScaMethod scaMethod, SpiSinglePayment businessObject, AspspConsentData aspspConsentData) {
