...
public enum SpiMessageErrorCode {
    ...
    private static Map<String, SpiMessageErrorCode> container = new HashMap<>();
    ...
    @JsonIgnore
    public static Optional<SpiMessageErrorCode> getByName(String name) {
