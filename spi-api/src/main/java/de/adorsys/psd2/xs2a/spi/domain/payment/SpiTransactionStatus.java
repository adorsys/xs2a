...
public enum SpiTransactionStatus {
    ...
    private static Map<String, SpiTransactionStatus> container = new HashMap<>();
    ...
    SpiTransactionStatus(String transactionStatus, boolean finalisedStatus) {
        this.transactionStatusString = transactionStatus;
        this.finalisedStatus = finalisedStatus;
    }

    public static SpiTransactionStatus getByValue(String transactionStatus) {
