...
public class AccountReference {
	...
	@ApiModelProperty(value = "PAN: Primary AccountResponse Number (PAN) of a card, can be tokenized by the ASPSP due to PCI DSS requirements.", required = false, example = "1111")
	private String pan;
