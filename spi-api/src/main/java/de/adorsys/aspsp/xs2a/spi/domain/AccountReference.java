...
public class AccountReference {
    ...
    @ApiModelProperty(value = "IBAN: This data element can be used in the body of the AccountInformationConsentRequestBody Request Message for retrieving account access consent from this payment account", required = false, example = "DE2310010010123456789")
    private String iban;
    ...
    /**
     *  Constructor converts AccountDetails to own type
     *
     * @param accountDetails  accountDetails which the response is given for
     */
    public AccountReference(AccountDetails accountDetails) {
