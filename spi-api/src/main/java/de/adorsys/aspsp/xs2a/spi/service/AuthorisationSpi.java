...
interface AuthorisationSpi<T> {
     ...
     * @param busynessObject   generic payment object
     ...
     */
    SpiResponse<SpiAuthorisationStatus> authorisePsu(String psuId, String password, T busynessObject, AspspConsentData aspspConsentData);
     ...
     */
    SpiResponse<List<SpiScaMethod>> requestAvailableScaMethods(String psuId, T busynessObject, AspspConsentData aspspConsentData);
     ...
     */
    SpiResponse requestAuthorisationCode(String psuId, SpiScaMethod scaMethod, T busynessObject, AspspConsentData aspspConsentData);
     ...
     * @return Return a positive or negative response as part of SpiResponse
     */
    SpiResponse verifyAuthorisationCodeAndExecuteRequest(SpiScaConfirmation spiScaConfirmation, T busynessObject, AspspConsentData aspspConsentData);
}
