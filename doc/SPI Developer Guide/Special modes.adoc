...
* At first put PSD2 API yaml file to the resource folder of your Connector to override default PSD2 API and
set `xs2a.swagger.psd2.api.location` property in your application.properties file e.g. `xs2a.swagger.psd.api.location=path/in/my/classpath/my_swagger_api.yml`
