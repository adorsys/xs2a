...
For the versions available, see the https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/-/tags[tags on this repository]
...
xref:XS2A. Details of realisation/Read Account Data Requests.adoc[Download Link]
...
xref:XS2A. Details of realisation/Read Account data Requests.adoc[Standing order report]
...
xref:XS2A. Details of realisation/Read Account data Requests.adoc[Delta access for transaction list request]
...
Functionality allows PSU to Establish Funds Confirmation Consent to TPP through XS2A interface.
