...
* xref:release_notes/Release_notes_4.0.adoc[Version 4.0  (release date: ?)]

=== Mainline 3.x (Development. Planned release ? as 4.0)
...
* xref:release_notes/Release_notes_2.13.adoc[Version 2.13  (release date: 16.08.2019)]
