...
* xref:release_notes/Release_notes_13.7.adoc[Version 13.7 (release date: xx.xx.2022)]
...
* xref:release_notes/Release_notes_12.7.adoc[Version 12.7 (release date: xx.xx.2022)]
