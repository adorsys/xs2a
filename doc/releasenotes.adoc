...
* xref:release_notes/Release_notes_11.0.adoc[Version 11.0 (release date: ?)]

=== Mainline 10.x (Stable. Supported minimum till 13.09.2021)

* xref:release_notes/Release_notes_10.0.adoc[Version 10.0  (release date: ?)]
...
* xref:release_notes/Release_notes_8.10.adoc[Version 8.12  (release date: ?)]
* xref:release_notes/Release_notes_8.10.adoc[Version 8.11  (release date: 10.03.2021)]
