...
=== Mainline 5.x (Development. Planned to be released 13.03.2020 as 6.0 Stable version)

=== Mainline 4.x (Stable. Supported minimum till 01.03.2020)

* xref:release_notes/Release_notes_4.11.adoc[Version 4.11  (release date: ?)]
* xref:release_notes/Release_notes_4.10.adoc[Version 4.10  (release date: 14.02.2020)]
* xref:release_notes/Release_notes_4.9.adoc[Version 4.9  (release date: 31.01.2020)]
