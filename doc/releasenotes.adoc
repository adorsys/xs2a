...
* xref:release_notes/Release_notes_15.9.adoc[Version 15.9 (release date: xx.xx.2023)]
...
* xref:release_notes/Release_notes_14.9.adoc[Version 14.9 (release date: xx.xx.2023)]
