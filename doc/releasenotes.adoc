...
* xref:release_notes/Release_notes_15.2.adoc[Version 15.2 (release date: xx.xx.2022)]
...
* xref:release_notes/Release_notes_14.2.adoc[Version 14.2 (release date: xx.xx.2022)]
