...
* xref:release_notes/Release_notes_8.12.adoc[Version 8.12  (release date: ?)]
...
* xref:release_notes/Release_notes_8.9.adoc[Version 8.9  (release date: 10.02.2021)]
...
* xref:release_notes/Release_notes_8.6.adoc[Version 8.6  (release date: 30.12.2020)]
