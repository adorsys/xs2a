...
* xref:release_notes/Release_notes_13.6.adoc[Version 13.6 (release date: xx.xx.xxxx)]
...
* xref:release_notes/Release_notes_12.6.adoc[Version 12.6 (release date: xx.xx.xxxx)]
