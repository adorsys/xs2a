...
* xref:release_notes/Release_notes_15.8.adoc[Version 15.8 (release date: xx.xx.2023)]
...
* xref:release_notes/Release_notes_14.8.adoc[Version 14.8 (release date: xx.xx.2023)]
