...
==== Mainline 6.x (Planned to be supported till 01.09.2020)

Mainline 6.x based on xs2a v.5.11 is released on 13.03.2019. The main goal is to support mandatory requirements of Berlin Group specification 1.3.6 and fix bugs.
...
==== Mainline 7.x (Planned to be released 13.09.2020 as 8.0 Stable version)
