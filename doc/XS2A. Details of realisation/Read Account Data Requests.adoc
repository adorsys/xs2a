...
|Optional
|If contained, corresponding transactions page returned. This parameter might be ignored by the ASPSP.
|

|itemsPerPage

|Optional
|If contained, corresponding transactions number on page returned. This parameter might be ignored by the ASPSP.
|
|===
