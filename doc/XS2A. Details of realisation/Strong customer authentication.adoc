...
XS2A Interface supports multiple SCA approaches. https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/-/tree/support-14x/aspsp-profile[ASPSP-Profile] may contain a list of approaches (in order of priority - first one with the highest priority).
