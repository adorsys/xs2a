...
In https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/-/tree/develop/aspsp-profile[ASPSP Profile] support of relative links look like:
```
...
* Clone https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a, build and execute certificate-generator. Alternatively use the TPP certificate generator mentioned in 01 Links to the environments.
...
* Clone https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a and find certificate-generator service;
