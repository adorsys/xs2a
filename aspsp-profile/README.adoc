...
|scaRedirectFlow |This field defines variant of the SCA redirect approach. |REDIRECT |REDIRECT, OAUTH, OAUTH_PRE_STEP
|oauthConfigurationUrl |The link to identity provider (IDP) for OAuth. |http://localhost:4200/idp/ |String
