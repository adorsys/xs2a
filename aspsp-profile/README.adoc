...
If the parameter = FALSE, then XS2A sends the response with CONSENT_INVALID and text "An explicit consent of ownerName is not supported."
...
If parameter = FALSE then TPP URIs should not be checked for compliance. If it is TRUE then TPP URIs should be checked. |FALSE |TRUE, FALSE
|===
