...
@Tag(name = CmsAspspApiTagName.ASPSP_EXPORT_PAYMENTS, description = "Provides access to the consent management system for exporting PIS payments by ASPSP")
public interface CmsAspspPisExportApi {

    @GetMapping(path = "/tpp/{tpp-id}")
    @Operation(description = "Returns a list of payments by given mandatory TPP ID, optional creation date, PSU ID Data and instance ID")
    @ApiResponses(value = {
    ...
    ResponseData<Collection<CmsBasePaymentResponse>> getPaymentsByTpp(
        ...
        @Parameter(description = "Quantity of payments on one page", example = "20")
        @RequestParam(value = CmsConstant.QUERY.ITEMS_PER_PAGE, defaultValue = "20") Integer itemsPerPage);

    @GetMapping(path = "/psu")
    @Operation(description = "Returns a list of payments by given mandatory PSU ID Data, optional creation date and instance ID")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "OK")})
    ...
    @Operation(description = "Returns a list of payments by given mandatory ASPSP account ID, optional creation date and instance ID")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "OK")})
