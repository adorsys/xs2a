...
@Tag(name = InternalCmsXs2aApiTagName.PIS_PSU_DATA, description = "Provides access to consent management system for PSU Data")
public interface PisPsuDataApi {

    @GetMapping(path = "/payment/{payment-id}/psu-data")
    @Operation(description = "Get PSU data identified by given payment ID")
    @ApiResponses(value = {
