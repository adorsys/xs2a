...
class AisConsentControllerTest {
    ...
    void createConsentAuthorization_Success() {
        ...
        assertEquals(AUTHORIZATION_ID, responseEntity.getBody().getAuthorizationId());
    }
    ...
    void getConsentAuthorization_Success() {
        ...
        //Then:
        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
        assertEquals(getConsentAuthorizationResponse(), responseEntity.getBody());
    }
    ...
    private CreateAisConsentAuthorizationResponse buildCreateAisConsentAuthorizationResponse() {
        return new CreateAisConsentAuthorizationResponse(AUTHORIZATION_ID, ScaStatus.RECEIVED, "", null);
    }
