...
public class UpdatePisConsentBlobMethod extends RestCmsRequestMethod<UpdateConsentAspspDataRequest, CreatePisConsentResponse> {
    private static final String UPDATE_PIS_CONSENT_BLOB_URI = "api/v1/pis/consent/{consent-id}/blob";

    public UpdatePisConsentBlobMethod(final UpdateConsentAspspDataRequest request, HttpUriParams uriParams) {
