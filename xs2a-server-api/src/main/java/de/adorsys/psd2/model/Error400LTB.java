 ...
 */
@Schema(description = "Standardised definition of reporting error information according to [RFC7807] in case of a HTTP error code 400 for Trusted Beneficiaries. ")
@Validated
...
public class Error400LTB   {
  ...
  public Error400LTB _links(LinksAll _links) {
    this._links = _links;
    return this;
  }
