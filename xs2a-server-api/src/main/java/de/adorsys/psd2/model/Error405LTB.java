 ...
 */
@Schema(description = "Standardised definition of reporting error information according to [RFC7807] in case of a HTTP error code 405 for Trusted Beneficiaries. ")
@Validated
...
public class Error405LTB   {
  ...
  public Error405LTB _links(LinksAll _links) {
    this._links = _links;
    return this;
  }
