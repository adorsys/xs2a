...
public class StandingOrderDetails   {
  ...
  @Valid
  private List<MonthsOfExecution> monthsOfExecution = null;
  ...
  **/
  ...
  public StandingOrderDetails monthsOfExecution(List<MonthsOfExecution> monthsOfExecution) {
    this.monthsOfExecution = monthsOfExecution;
    return this;
  }

  public StandingOrderDetails addMonthsOfExecutionItem(MonthsOfExecution monthsOfExecutionItem) {
