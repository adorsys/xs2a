 ...
 */
@Schema(description = "Standardised definition of reporting error information according to [RFC7807] in case of a HTTP error code 401 for Trusted Beneficiaries. ")
@Validated
...
public class Error401LTB   {
  ...
  public Error401LTB code(MessageCode401LTB code) {
    this.code = code;
    return this;
  }
  ...
  public Error401LTB _links(LinksAll _links) {
    this._links = _links;
    return this;
  }
