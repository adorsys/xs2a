...
public interface SigningBasketApi {
    ...
    @ApiOperation(value = "Return the content of an signing basket object", nickname = "getSigningBasket", notes = "Returns the content of a signing basket object.", response = SigningBasketResponse200.class, authorizations = {
        @Authorization(value = "BearerAuthOAuth")
    }, tags={  })
    @ApiResponses(value = {
