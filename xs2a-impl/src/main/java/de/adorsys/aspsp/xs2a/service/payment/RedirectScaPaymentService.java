...
public class RedirectScaPaymentService implements ScaPaymentService {
    ...
    public Optional<PaymentInitialisationResponse> createPeriodicPayment(PeriodicPayment periodicPayment, String paymentProduct) {
        return createPeriodicPaymentAndGetResponse(periodicPayment)
                   ...
                   .map(resp -> createConsentForPeriodicPaymentAndExtendPaymentResponse(periodicPayment, resp, paymentProduct));
    }
    ...
    private PaymentInitialisationResponse createConsentForPeriodicPaymentAndExtendPaymentResponse(PeriodicPayment periodicPayment, PaymentInitialisationResponse response, String paymentProduct) {
        String pisConsentId = pisConsentService.createPisConsentForPeriodicPaymentAndGetId(periodicPayment, response.getPaymentId(), paymentProduct);
    ...
    public List<PaymentInitialisationResponse> createBulkPayment(List<SinglePayment> payments, String paymentProduct) {
        ...
        return MapUtils.isNotEmpty(paymentIdentifierMap)
                   ? createConsentForBulkPaymentAndExtendPaymentResponses(paymentIdentifierMap, paymentProduct)
    ...
    private List<PaymentInitialisationResponse> createConsentForBulkPaymentAndExtendPaymentResponses(Map<SinglePayment, PaymentInitialisationResponse> paymentIdentifierMap, String paymentProduct) {
        String pisConsentId = pisConsentService.createPisConsentForBulkPaymentAndGetId(paymentIdentifierMap, paymentProduct);
    ...
    public Optional<PaymentInitialisationResponse> createSinglePayment(SinglePayment singlePayment, String paymentProduct) {
        return createSinglePaymentAndGetResponse(singlePayment)
                   ...
                   .map(resp -> createConsentForSinglePaymentAndExtendPaymentResponse(singlePayment, resp, paymentProduct));
    }
    ...
    private PaymentInitialisationResponse createConsentForSinglePaymentAndExtendPaymentResponse(SinglePayment singlePayment, PaymentInitialisationResponse response, String paymentProduct) {

        String pisConsentId = pisConsentService.createPisConsentForSinglePaymentAndGetId(singlePayment, response.getPaymentId(), paymentProduct);
