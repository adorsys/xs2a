...
public class AccountService {
    ...
    public ResponseObject<AccountDetails> getAccountDetails(String consentId, String accountId, boolean withBalance) {
        ...
        AccountDetails accountDetails = accountMapper.mapToAccountDetails(accountSpi.readAccountDetails(accountId,  "".getBytes()).getPayload()); // TODO https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/issues/191 Put a real data here
    ...
    private Optional<AccountReport> getAccountReportByTransaction(String transactionId, String accountId) {
        ...
        Optional<SpiTransaction> transaction = accountSpi.readTransactionById(transactionId, accountId,  "".getBytes()).getPayload(); // TODO https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/issues/191 Put a real data here
    ...
    private Optional<AccountReport> getAccountReportByPeriod(String accountId, LocalDate dateFrom, LocalDate dateTo) { //TODO to be reviewed upon change to v1.1
        ...
        return accountMapper.mapToAccountReport(accountSpi.readTransactionsByPeriod(accountId, dateFrom, dateTo,  "".getBytes()).getPayload()); // TODO https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/issues/191 Put a real data here
    }
    ...
    public Optional<AccountDetails> getAccountDetailsByAccountReference(AccountReference reference) {
        return Optional.ofNullable(reference) // TODO https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/issues/191 Refactor to procedure style - we read data inside the stream here
                   .map(ref -> accountSpi.readAccountDetailsByIban(ref.getIban(),  "".getBytes()).getPayload()) // TODO https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/issues/191 Put a real data here
    ...
    public boolean isInvalidPaymentProductForPsu(AccountReference reference, String paymentProduct) {
        return !accountSpi.readPsuAllowedPaymentProductList(accountMapper.mapToSpiAccountReference(reference), "".getBytes()).getPayload() // TODO https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/issues/191 Put a real data here
