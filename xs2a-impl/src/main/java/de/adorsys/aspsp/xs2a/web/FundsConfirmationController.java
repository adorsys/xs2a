...
public class FundsConfirmationController {
    ...
    @ApiImplicitParams({
        ...
        @ApiImplicitParam(name = "tpp-request-id", value = "16d40f49-a110-4344-a949-f99828ae13c9", required = true, dataType = "UUID", paramType = "header")})
    public ResponseEntity<FundsConfirmationResponse> fundConfirmation(@RequestBody FundsConfirmationRequest request) {
        return responseMapper.okOrBadRequest(fundsConfirmationService.fundsConfirmation(request));
    }
}
