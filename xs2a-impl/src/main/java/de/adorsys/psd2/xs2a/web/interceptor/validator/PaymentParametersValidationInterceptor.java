 ...
 * registered (and launched) before the main request interceptor, because ASPSP profile configuration is autowired here
 * and some documentation-specific HTTP codes are returned from it.
 * <p>
...
public class PaymentParametersValidationInterceptor extends HandlerInterceptorAdapter {
    ...
    private boolean isRequestValid(HttpServletRequest request, HttpServletResponse response, Object handler) throws IOException {
        ...
        if (handler instanceof HandlerMethod) {
            ...
            // Filter requests, which are addressed to payment API
