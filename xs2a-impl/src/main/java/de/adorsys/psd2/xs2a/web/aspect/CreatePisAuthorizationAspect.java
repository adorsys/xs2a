...
public class CreatePisAuthorizationAspect extends AbstractLinkAspect<PaymentController> {
    ...
    private Links buildLink(String paymentService, String paymentProduct, String paymentId, String authorizationId) {
        ...
        links.setStartAuthorisationWithPsuAuthentication(buildPath("/v1/{paymentService}/{paymentProduct}/{paymentId}/authorisations/{authorisationId}", paymentService, paymentProduct, paymentId, authorizationId));
        return links;
    }
}
