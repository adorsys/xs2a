...
import de.adorsys.psd2.xs2a.web.validator.body.raw.FundsConfirmationRawBodyValidator;
...
@Component
public class FundsConfirmationMethodValidationImpl extends AbstractMethodValidator<FundsConfirmationHeaderValidator, FundsConfirmationRawBodyValidator, FundsConfirmationBodyValidator, QueryParameterValidator> {
    ...
    public FundsConfirmationMethodValidationImpl(List<FundsConfirmationHeaderValidator> headerValidators, List<FundsConfirmationBodyValidator> bodyValidators) {
        super(headerValidators, Collections.emptyList(), bodyValidators, Collections.emptyList());
    }
