...
/**
 * Payment object that contains necessary information for validating payment in {@link CancelPaymentValidator}
 */
@Value
public class CancelPaymentPO implements PaymentTypeAndInfoProvider {
    @NotNull
