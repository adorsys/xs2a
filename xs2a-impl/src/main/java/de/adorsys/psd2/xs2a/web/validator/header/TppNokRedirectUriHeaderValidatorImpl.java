...
public class TppNokRedirectUriHeaderValidatorImpl extends AbstractHeaderValidatorImpl
    ...
    @Autowired
    public TppNokRedirectUriHeaderValidatorImpl(ErrorBuildingService errorBuildingService, TppDomainValidator tppDomainValidator, ScaApproachResolver scaApproachResolver) {
