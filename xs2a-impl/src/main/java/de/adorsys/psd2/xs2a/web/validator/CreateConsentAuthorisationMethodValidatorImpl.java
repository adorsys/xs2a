...
@Component
public class CreateConsentAuthorisationMethodValidatorImpl extends AbstractMethodValidator<CreateAuthorisationHeaderValidator, BodyValidator, QueryParameterValidator, PathParameterValidator> {
