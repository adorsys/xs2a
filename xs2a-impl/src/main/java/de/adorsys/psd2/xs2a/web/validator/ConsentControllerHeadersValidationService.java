...
/**
 * Service to be used to validate ConsentController headers.
 */
@Service
@RequiredArgsConstructor
public class ConsentControllerHeadersValidationService {
     ...
     */
    public ValidationResult validateCreateConsent() {
