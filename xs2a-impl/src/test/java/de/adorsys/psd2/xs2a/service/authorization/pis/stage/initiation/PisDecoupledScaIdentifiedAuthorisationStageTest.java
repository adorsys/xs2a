...
class PisDecoupledScaIdentifiedAuthorisationStageTest {
    ...
    void apply_Success() {
        ...
        Xs2aUpdatePisCommonPaymentPsuDataResponse actualResponse = pisDecoupledScaIdentifiedAuthorisationStage.apply(request, response);
