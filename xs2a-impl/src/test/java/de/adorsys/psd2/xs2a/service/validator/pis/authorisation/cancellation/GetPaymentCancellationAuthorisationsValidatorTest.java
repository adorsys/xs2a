...
public class GetPaymentCancellationAuthorisationsValidatorTest {
    ...
    public void setUp() {
        ...
        getPaymentCancellationAuthorisationsValidator.setPisValidators(pisTppInfoValidator, paymentProductAndTypeValidator);
