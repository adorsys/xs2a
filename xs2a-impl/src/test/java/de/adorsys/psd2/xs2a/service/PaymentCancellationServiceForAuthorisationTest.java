...
class PaymentCancellationServiceForAuthorisationTest {
    ...
    void getPaymentAuthorisationScaStatus_successNotFinalised() {
        ...
        SpiResponse<SpiScaInformationResponse> spiResponse = SpiResponse.<SpiScaInformationResponse>builder()
                                                            ...
                                                            .build();
        when(paymentCancellationSpi.getScaInformation(SPI_CONTEXT_DATA, AUTHORISATION_ID, spiAspspConsentDataProvider)).thenReturn(spiResponse);
    ...
    void getPaymentAuthorisationScaStatus_spiError() {
        ...
        assertThat(actual).isNotNull();
        assertThat(actual.hasError()).isTrue();
        verify(paymentCancellationSpi, times(1)).getScaInformation(SPI_CONTEXT_DATA, AUTHORISATION_ID, spiAspspConsentDataProvider);
