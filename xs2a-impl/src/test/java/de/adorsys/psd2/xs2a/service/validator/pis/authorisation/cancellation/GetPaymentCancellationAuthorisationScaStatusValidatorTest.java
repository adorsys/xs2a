...
public class GetPaymentCancellationAuthorisationScaStatusValidatorTest {
    ...
    public void validate_withInvalidAuthorisation_shouldReturnAuthorisationValidationError() {
        ...
        // When
        ValidationResult validationResult = getPaymentCancellationAuthorisationScaStatusValidator.validate(new GetPaymentCancellationAuthorisationScaStatusPO(commonPaymentResponse, WRONG_AUTHORISATION_ID));
