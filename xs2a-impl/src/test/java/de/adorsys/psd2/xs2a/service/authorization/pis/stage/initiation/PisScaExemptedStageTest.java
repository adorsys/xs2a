...
public class PisScaExemptedStageTest {

    @InjectMocks
    private PisScaExemptedStage pisScaExemptedStage;
    ...
    public void apply_Success() {
        Xs2aUpdatePisCommonPaymentPsuDataResponse actualResponse = pisScaExemptedStage.apply(request, response);
