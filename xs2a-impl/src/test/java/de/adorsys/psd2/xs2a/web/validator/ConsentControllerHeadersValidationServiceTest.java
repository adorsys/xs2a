...
public class ConsentControllerHeadersValidationServiceTest {
    ...
    private static final ErrorType ERROR_TYPE_AIS_400 = ErrorType.AIS_400;
    ...
    public void validateCreateConsent_Failure_TppRedirectUriIsNotValid() {
        ...
        ValidationResult actualResult = headersValidationService.validateCreateConsent();
        ...
        assertThat(messageError.getErrorType()).isEqualTo(ERROR_TYPE_AIS_400);
