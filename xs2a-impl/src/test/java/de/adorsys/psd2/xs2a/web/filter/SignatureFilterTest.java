...
public class SignatureFilterTest {
    ...
    @Test
    public void doFilterInternal_invalid_digest() throws IOException, ServletException {
        // given
        MockHttpServletRequest mockRequest = getCorrectRequest(headerMap, body, POST_METHOD);
        MockHttpServletResponse mockResponse = new MockHttpServletResponse();
    ...
    @Test
    public void doFilterInternal_invalid_signature() throws IOException, ServletException {
        // given
        MockHttpServletRequest mockRequest = getCorrectRequest(headerMap, body, POST_METHOD);
        MockHttpServletResponse mockResponse = new MockHttpServletResponse();
        String fullUrl = mockRequest.getRequestURL().toString();
    ...
    @Test
    public void doFilterInternal_SignatureRequired_Off() throws IOException, ServletException {
        // given
        MockHttpServletRequest mockRequest = getCorrectRequest(headerMap, body, POST_METHOD);
        MockHttpServletResponse mockResponse = new MockHttpServletResponse();
    ...
    @Test
    public void doFilterInternal_HeaderEmpty_xRequestId() throws IOException, ServletException {
        // given
    ...
    @Test
    public void doFilterInternal_HeaderEmpty_signature() throws IOException, ServletException {
        // given
    ...
    @Test
    public void doFilterInternal_HeaderEmpty_signature_certificate() throws IOException, ServletException {
        // given
    ...
    @Test
    public void doFilterInternal_HeaderEmpty_signature_digest() throws IOException, ServletException {
        // given
    ...
    @Test
    public void doFilterInternal_HeaderEmpty_date() throws IOException, ServletException {
        // given
