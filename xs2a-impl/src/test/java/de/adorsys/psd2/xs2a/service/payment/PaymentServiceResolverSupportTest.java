...
//import de.adorsys.psd2.xs2a.service.payment.support.PaymentServiceResolverSupport;
...
//import de.adorsys.psd2.xs2a.service.payment.support.create.CreateCommonPaymentService;
...
//import de.adorsys.psd2.xs2a.service.payment.support.read.ReadSinglePaymentService;
...
//        ReadPaymentService readPaymentService = paymentServiceResolverSupport.getReadPaymentService(commonPaymentData);
...
//
//        // When
//        paymentServiceResolverSupport.getCreatePaymentService(paymentInitiationParameters);
//    }
//
//    @Test(expected = UnsupportedOperationException.class)
...
//
//        CancelPaymentService cancelPaymentService = paymentServiceResolverSupport.getCancelPaymentService(paymentCancellationRequest);
