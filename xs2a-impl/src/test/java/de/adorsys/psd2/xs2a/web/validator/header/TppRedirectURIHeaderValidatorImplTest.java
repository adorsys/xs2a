...
public class TppRedirectURIHeaderValidatorImplTest {

    private TppRedirectURIHeaderValidatorImpl validator;
    private MessageError messageError;
    private Map<String, String> headers;

    @Before
    public void setUp() {
        validator = new TppRedirectURIHeaderValidatorImpl(new ErrorBuildingServiceMock(ErrorType.AIS_400));
    ...
    public void validate_success() {
        ...
        headers.put(TPP_REDIRECT_PREFERRED, "false");
        validator.validate(headers, messageError);
        assertTrue(messageError.getTppMessages().isEmpty());

        headers.put(TPP_REDIRECT_PREFERRED, "true");
        headers.put(validator.getHeaderName(), "ok.url");
        validator.validate(headers, messageError);
        assertTrue(messageError.getTppMessages().isEmpty());
    }
