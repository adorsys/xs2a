...
public enum AspspAccountType {
    ...
    private final static Map<String, AspspAccountType> container = new HashMap<>();

    static {
        for (AspspAccountType accountType : values()) {
    ...
    @JsonIgnore
    public static Optional<AspspAccountType> getByValue(String value) {
