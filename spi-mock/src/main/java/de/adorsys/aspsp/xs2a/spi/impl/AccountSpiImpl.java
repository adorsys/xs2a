    ...
    public SpiResponse<List<SpiAccountDetails>> readAccountDetailsByIbans(Collection<String> ibans, byte[] aspspConsentData) {
        ...
        for (String iban : ibans) {
            ...
            if (CollectionUtils.isEmpty(det)) {
                return new SpiResponse<>(Collections.emptyList(),  "".getBytes()); // TODO https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/issues/191 Put a real data here
            }
            accountDetails.addAll(det);
        }

        return new SpiResponse<>(accountDetails,  "".getBytes()); // TODO https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/issues/191 Put a real data here
    }
