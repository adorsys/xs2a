...
public class PeriodicPaymentSpiImpl implements PeriodicPaymentSpi {
    ...
    @Override
    public SpiResponse verifyAuthorisationCodeAndExecutePayment(SpiPaymentConfirmation spiPaymentConfirmation, SpiPeriodicPayment payment, AspspConsentData aspspConsentData) {
        return null;
    }

    @Override
    public SpiResponse<SpiPeriodicPayment> getPaymentById(SpiPeriodicPayment payment, String paymentId, AspspConsentData aspspConsentData) {
        return null;
    }
