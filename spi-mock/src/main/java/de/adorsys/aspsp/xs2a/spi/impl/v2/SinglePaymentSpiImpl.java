...
public class SinglePaymentSpiImpl implements SinglePaymentSpi {
    ...
    @Override
    public SpiResponse verifyAuthorisationCodeAndExecutePayment(SpiPaymentConfirmation spiPaymentConfirmation, SpiSinglePayment payment, AspspConsentData aspspConsentData) {
        return null;
    }
