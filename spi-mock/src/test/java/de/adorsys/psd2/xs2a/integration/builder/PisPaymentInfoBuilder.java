...
public class PisPaymentInfoBuilder {
    ...
    public static PisPaymentInfo buildPisPaymentInfo(String paymentProduct, PaymentType paymentType, boolean multilevelScaRequired) {
        PisPaymentInfo paymentInfo = new PisPaymentInfo();
        paymentInfo.setPaymentId(null);
        paymentInfo.setPaymentProduct(paymentProduct);
        paymentInfo.setPaymentType(paymentType);
        paymentInfo.setTransactionStatus(null);
        paymentInfo.setTppInfo(TPP_INFO);
        paymentInfo.setPsuDataList(Collections.singletonList(PSU_DATA));
        paymentInfo.setAspspAccountId(null);
        paymentInfo.setMultilevelScaRequired(multilevelScaRequired);
        return paymentInfo;
    }
