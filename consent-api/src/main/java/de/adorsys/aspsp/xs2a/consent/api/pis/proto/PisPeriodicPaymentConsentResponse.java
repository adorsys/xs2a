...
@Data
@ApiModel(description = "Pis periodic payment initialisation consent response", value = "PisPeriodicPaymentConsentResponse")
public class PisPeriodicPaymentConsentResponse extends PisAbstractConsentResponse{
