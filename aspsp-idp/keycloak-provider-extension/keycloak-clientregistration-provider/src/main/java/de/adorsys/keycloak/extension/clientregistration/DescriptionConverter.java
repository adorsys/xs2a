...
public class DescriptionConverter {
    ...
    public static ClientRepresentation toInternal(KeycloakSession session, OIDCClientRepresentationExtended clientOIDC)
        ...
        if (authMethod == null) {
            clientAuthFactory = (ClientAuthenticatorFactory) session.getKeycloakSessionFactory().getProviderFactory(
                ClientAuthenticator.class, KeycloakModelUtils.getDefaultClientAuthenticatorType());
        } else {
    ...
    private static boolean setPublicKey(OIDCClientRepresentation clientOIDC, ClientRepresentation clientRep) { //NOPMD
        ...
        if (clientOIDC.getJwks() != null) {
            ...
            if (publicKeyJWk == null) {
                ...
                CertificateInfoHelper.updateClientRepresentationCertificateInfo(clientRep, rep,
                    JWTClientAuthenticator.ATTR_PREFIX);
    ...
    public static OIDCClientRepresentationExtended toExternalResponse(KeycloakSession session,
        ...
        Set<String> oidcClientAuthMethods = clientAuth
                                                .getProtocolAuthenticatorMethods(OIDCLoginProtocol.LOGIN_PROTOCOL);
